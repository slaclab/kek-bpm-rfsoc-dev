...
def parse_and_plot(dat_file):
    ...
    #plt.savefig(f'/home/nomaru/work/auto_BOR/plot/{recordtime[0]}/LERDV_{recordtime[0]}_plot.png',dpi=200,bbox_inches="tight",pad_inches=0.5)
    ...
    plt.subplots_adjust(hspace=.1)
    #plt.savefig(f'/home/nomaru/work/auto_BOR/plot/{recordtime[0]}/LERUV_{recordtime[0]}_plot.png',dpi=200,bbox_inches="tight",pad_inches=0.5)
