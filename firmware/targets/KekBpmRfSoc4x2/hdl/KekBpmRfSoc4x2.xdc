...
set_clock_groups -asynchronous -group [get_clocks -of_objects [get_pins U_RFDC/U_Pll/PllGen.U_Pll/CLKOUT1]] -group [get_clocks -of_objects [get_pins U_RFDC/U_BUFGCE_DIV/O]]
