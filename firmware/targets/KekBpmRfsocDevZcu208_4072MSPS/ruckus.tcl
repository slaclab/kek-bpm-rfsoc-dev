...
loadSource -dir "$::env(TOP_DIR)/shared/rtl/4072MSPS"

# Load model composer .ZIP output file
if { [get_ips ssr_ddc_0] eq ""  } {
   loadZipIpCore  -repo_path $::env(IP_REPO) -dir "$::env(TOP_DIR)/shared/model_composer/SSR16_Digital_Down_Conversion/netlist/ip"
